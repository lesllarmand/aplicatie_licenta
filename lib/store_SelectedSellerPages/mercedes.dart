...
import 'package:service_now/store_SelectedSellerPages/mercedes_item_tile.dart';
            ...
            Expanded(
              child: Consumer<CartModel>(builder: (context, value, child) {
                return GridView.builder(
                  itemCount: value.shopMercedes.length,
                  padding: EdgeInsets.all(12),
                  gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                      // how many items to be in each row, I chose 2
                      crossAxisCount: 2),
                  itemBuilder: (context, index) {
                    return MercedesItemTile(
                      itemName: value.shopMercedes[index][0],
                      imagePath: value.shopMercedes[index][1],
                      color: value.shopMercedes[index][2],
                    );
                  },
                );
              }),
